...
async def main():
    ...
    sensors = [
        Sensor("temperature", lat, lon, config["sensors"]["temperature"]["interval_ms"]),
        Sensor("humidity", lat, lon, config["sensors"]["humidity"]["interval_ms"]),
        Sensor("light", lat, lon, config["sensors"]["light"]["interval_ms"])
    ]
